<footer class="mt-6 text-gray-700 bg-white border-t ">
    <div
        ...
        <div class="flex flex-wrap flex-grow mx-auto mt-10 -mb-10 text-left md:mt-0 ">
            <div class="w-full lg:w-1/3 md:w-full">
                <h4 class="mb-2 text-2xl font-bold text-center text-black lg:text-left">
                    Take your trip with Us, cheap price, full services, full support.
                </h4>
            </div>
            <div class="w-full text-right lg:w-1/3 md:w-1/2 ">
                <h4 class="mb-3 text-sm font-semibold tracking-widest text-black uppercase ">
                    Company
                </h4>
            ...
            <div class="w-full text-right lg:w-1/3 md:w-1/2">
                <h4 class="mb-3 text-sm font-semibold tracking-widest text-black uppercase ">Legal
                </h4>
                <nav class="mb-10 list-none">
                    <li>
    ...
    <div class="bg-black">
        <div class="flex flex-col flex-wrap px-5 py-6 mx-auto lg:px-20 sm:flex-row">
